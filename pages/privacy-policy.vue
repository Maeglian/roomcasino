  ...
  <section class="SupportPage">
    ...
    <ul class="SupportPage-List">
      <li class="SupportPage-Item">
        ...
        <p class="Text">
          Our Policy explains how we use your personal data, whether you are just visiting, making a
          deposit or playing one of our games. This policy includes information you may not already
          know about your data privacy rights, circumstances in which we share and obtain
        ...
        <p class="Text">
          ...
          procedures whenever they handle your information.
        </p>
        <p class="Text">
      ...
      <li class="SupportPage-Item">
        ...
        <p class="Text">
          We process the Personal Information we collect from you in order to deliver our services.
          In particular, we will use your data for the following purposes:
        </p>
        <ul class="SupportPage-InnerList" type="a">
          ...
          <li class="SupportPage-InnerItem">
            <p class="Text">
              ...
              providing promotional information from our selected business partners, associates and
              affiliates (only if players specifically consented to receiving such marketing
              material);
            </p>
          </li>
          <li class="SupportPage-InnerItem">
      ...
      <li class="SupportPage-Item">
        ...
        <p class="Text">
          We may also lawfully receive certain Personal Information from online vendors and service
          providers, such as fraud prevention companies. In addition, we retain the right to engage
          the services of third-party providers to render technical support, so as to process your
          online transactions and source gaming content.
        </p>
        <p class="Text">
          Please understand that we may be granted access to any information you may provide to such
          vendors, service providers and third-party e-commerce services. Rest assured that we will
          use and safeguard any Personal Information so obtained, as set out in this Policy. Any
          information that you provide will only be disclosed to third parties outside the Company
          in accordance with this Privacy Policy, and we shall take any necessary steps to ensure
          that our agreements with third-party service providers always protect your private
          information.
        </p>
      </li>
    </ul>
