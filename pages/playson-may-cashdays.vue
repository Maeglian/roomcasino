<template>
  <section class="Page Page--full DailyTournamentPage">
    <div class="Page-Header DailyTournamentPage-Header">
      <div class="Wrapper">
        <div class="DailyTournamentPage-MainText DailyTournamentPage-MainText--left">
          <h1 class="Title Title--type-h1 Title--color1 DailyTournamentPage-Title">
            Playson may<br />
            cashdays
          </h1>
          ...
          <div
            ...
            v-html="$t('playsonMay.text')"
          ></div>
          <div
            v-else
            class="Text Text--additional DailyTournamentPage-Text"
            v-html="$t('playsonMay.textMobile')"
          ></div>
        </div>
      </div>
    </div>
    <section class="DailyTournamentPage-Content">
      <div class="DailyTournamentPage-Games">
        ...
        <Loader v-if="playsonMayGamesAreLoading" />
        <Games
          v-else
          class="DefaultGames-Cards"
          :games="playsonMayGames"
          :games-to-show="12"
      ...
      <div class="Page-Blocks DailyTournamentPage-Terms">
        <div v-for="(item, i) in $t('playsonMay.terms')" :key="`txt${i}`" class="Page-Block">
...
export default {
  ...
  computed: {
    ...mapState(['playsonMayGames', 'playsonMayGamesAreLoading', 'width']),
  },
  created() {
    this.getPlaysonMayGames();
  },
  methods: {
    ...mapActions(['getPlaysonMayGames']),
  },
};
</script>
